...
yn = str(input('\nBy participating in the MOS Prediction Challenge and downloading this Blizzard Challenge data, you agree to abide by the terms of use of this data.  This data may NOT be redistributed.  For more information, see https://www.cstr.ed.ac.uk/projects/blizzard/data.html.  Do you agree?  y/n > '))

if yn not in ['y', 'Y', 'yes']:
    print('You must agree to the terms to download the data and participate in the challenge.  Exiting.')
    exit()

os.system('mkdir -p blizzard')
...
sums = {'2008' : '5360686aac07ffe22420ffd00c90ea74',
